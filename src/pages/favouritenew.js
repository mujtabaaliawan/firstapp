                ...
                <div className="col-md-6 col-lg-5">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="monitor_field" value={monitor_field} onChange={(event) => setMonitorField(event.target.value)} required />
                        </div>
                        <div className="mb-3">
